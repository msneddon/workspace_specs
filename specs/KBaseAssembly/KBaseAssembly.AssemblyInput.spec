...
*/
typedef structure {
  list<#KBaseAssembly.PairedEndLibrary-2.0#> paired_end_libs;
  list<#KBaseAssembly.SingleEndLibrary-2.0#> single_end_libs;
  list<#KBaseAssembly.ReferenceAssembly-2.0#> references;
