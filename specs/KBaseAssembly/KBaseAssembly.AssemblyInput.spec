...
*/
typedef structure {
  list<#KBaseAssembly.PairedEndLibrary-1.1#> paired_end_libs;
  list<#KBaseAssembly.SingleEndLibrary-1.1#> single_end_libs;
  list<#KBaseAssembly.ReferenceAssembly-1.1#> references;
